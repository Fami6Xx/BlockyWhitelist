...
public abstract class EasyPaginatedMenu extends PaginatedMenu {
    ...
    public void handleMenu(InventoryClickEvent e){
        ...
        String closeName = ChatColor.stripColor(FamiUtils.format(Lang.closeItemDisplayName));
        String nextName = ChatColor.stripColor(FamiUtils.format(Lang.nextPageItemDisplayName));
        String previousName = ChatColor.stripColor(FamiUtils.format(Lang.previousPageItemDisplayName));
        ...
        }.runTask(BlockyWhitelist.getInstance());
    }
